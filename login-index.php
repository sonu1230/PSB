		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(img/bg-01.jpg);">
					...
					<form class="login100-form validate-form"  role="form" action="login-index.php" method="post">
					...
					<div class="container-login100-form-btn">
						...
						<button class="login100-form-btn" type= "submit" name="login">Login Now</button>
					</div>
				</form>
			</div>
		</div>
