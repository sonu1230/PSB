...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $conn->query("INSERT INTO  fees_transaction (stdid,paid,submitdate,transcation_remark) VALUES ('$sid','$advancefees','$joindate','$remark')") ;
   ...
   echo '<script type="text/javascript">window.location="student1.php?act=1";</script>';
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);
   ...
   echo '<script type="text/javascript">window.location="student1.php?act=2";</script>';
 }
...
header("location: student.php1?act=3");
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="student1.php" class="btn btn-primary btn-sm pull-right">Back <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="student1.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Add </a>';
						?>
						</h1>
		...
		?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<form action="student1.php" method="post" id="signupForm1" class="form-horizontal">
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a href="student1.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>

											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="student1.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
